...
export const slim = (groupForUpdate, smallerGroup) => {
    ...
    const prioritiesWithSlimmingPriority = eligibleForSlimming.map((priority) => (Object.assign(Object.assign({}, priority), { slimRatio: (findPriority(groupForUpdate, priority.id).weight - 1) / findPriority(smallerGroup, priority.id).weight })));
